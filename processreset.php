...
if ($_SESSION['admin'] == 1)
{
	...
	mysqli_query($connection, "UPDATE players SET brucies = 0, july = 0, august = 0, september = 0, october = 0, november = 0, december = 0, january = 0, february = 0, march = 0, april = 0, may = 0, june = 0");
	include("log.php");
	$action = "Reset game";
	writelog($action);
